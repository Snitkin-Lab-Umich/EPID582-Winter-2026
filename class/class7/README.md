...
Earlier, we learned how to perform basic and functional genome annotation using Prokka. Now we will perform some more targeted genome annotation and attempt to identify specific antibiotic resistance genes and mutations in a set of genomes.
